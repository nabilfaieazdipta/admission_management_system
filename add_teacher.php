...
session_start();
   ...
   if(isset($_POST['add_teacher']))
   {
    ...
    if($row_count==1)
    {
        ...
        $sql ="INSERT INTO user(name,email,usertype,phone,password,initial) 
        VALUES('$username','$user_email','$usertype','$user_phone','$user_password','$user_initial')";
        $result=mysqli_query($data,$sql);

        $tsql ="INSERT INTO teacher(name,email,phone,initial) 
        VALUES('$username','$user_email','$user_phone','$user_initial')";
        $result=mysqli_query($data,$tsql);
